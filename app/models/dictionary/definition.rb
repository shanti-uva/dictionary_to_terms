...
module Dictionary
  class Definition < DictionaryRecord
    ...
    has_many :not_fixed_associations, -> { where.not(category_branch_id: DefinitionCategoryAssociation::FIXED.keys) }, dependent: :destroy, class_name: 'DefinitionCategoryAssociation'
